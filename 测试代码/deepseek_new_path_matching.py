...
# 模型名称
MODEL_NAME = "my_deepseek_r1_7b:latest"
...
def main(input_csv, output_csv, start_index=0):
    ...
    kg_paths = {
        ...
        "判别式": "clean_判别式_15jfump_complete.json",
...
if __name__ == "__main__":
    ...
    output_csv = "/home/lms/project/dify-backend/data/test_data/user_middle_test_log/deepseek_comprehensive_match_output_user_middle_user_knowledge_profile.csv"
    
    main(input_csv, output_csv, 100)
